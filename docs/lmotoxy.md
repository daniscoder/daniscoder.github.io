...
**Файл LMO** - блок строк на каждый ПВ, колонки через табуляцию. Номер ПВ только
в первой строке блока, в остальных колонка ПВ пустая и строка начинается с
табуляции:
...
1001101	1.0	238.8	0.00	620.0
	...
	1305.6	10000000.0	575.67	3341.0
```
